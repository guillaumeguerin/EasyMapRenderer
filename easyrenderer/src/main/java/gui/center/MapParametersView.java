...
public class MapParametersView extends VBox {
    ...
    public HashMap<String, Boolean> checkedParameters = new HashMap<>();
    ...
    public MapParametersView() {
        ...
        listCheckboxes.getChildren().add(new CheckBox(COMPACTED));
        listCheckboxes.getChildren().add(new CheckBox(EARTH));
        listCheckboxes.getChildren().add(new CheckBox(FOOTWAY));
        listCheckboxes.getChildren().add(new CheckBox(FOREST));
        ...
        listCheckboxes.getChildren().add(new CheckBox(PATH));
        ...
        checkedParameters.put(COMPACTED, true);
        checkedParameters.put(EARTH, true);
        checkedParameters.put(FOOTWAY, true);
        checkedParameters.put(FOREST, true);
        ...
        checkedParameters.put(PATH, true);
